  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        // appBar: AppBar(
        //     title: (isConnecting
        //         ? Text('يتم الإتصال ب $serverName...')
        //         : isConnected
        //             ? Text('إتصال مباشر مع $serverName')
        //             : Text('سجل الدردشة $serverName'))),
        body: SafeArea(
          child: isConnecting
              ? const Text('Waiting')
              : Column(
...
class Stage extends StatefulWidget {
  final String stage;
  const Stage({required this.stage, super.key});
            ...
            child: Container(
                decoration: const BoxDecoration(
                    ...
                    border: Border(
                      ...
                      right: BorderSide(color: Colors.tealAccent),
                      left: BorderSide(color: Colors.tealAccent),
                    )),
                child: TextButton(
                    onPressed: () {},
                    child: Center(
